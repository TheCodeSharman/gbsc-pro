...
static const SourceKey::Polarity BenchPolarity = SourceKey::Positive;

static void seedSourceMeasurement()
{
    // The bench source drives separate H and V, which is the arrangement that
    // can state a polarity at all. Unset, the key records neither, which is a
    // source this fixture is not describing.
...
static void checkBenchGeometry()
{
    ...
    // closes on the write, nothing there having ever shown that row.
