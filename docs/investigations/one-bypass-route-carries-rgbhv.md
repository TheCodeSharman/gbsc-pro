...
So the band is not programmed blanking, not the played-out line's length, and
not where the output sync pulse sits. What differs between the routes and is
