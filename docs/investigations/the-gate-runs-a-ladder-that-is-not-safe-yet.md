...
with `Geometry::sourceIsPresent()` is step 4 of `docs/video-source-acquisition.md`,
...
`docs/video-source-acquisition.md` and step 12, and on the standard byte that forces
