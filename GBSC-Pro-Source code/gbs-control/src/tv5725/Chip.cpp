...
void Chip::init()
{
    ...
    DAC_RGBS_GPD::write(0x0);                    // s0_44[4:4]
    DAC_RGBS_G0ENZ::write(0x1);                  // s0_44[5:5]
    DAC_RGBS_G1EN::write(0x0);                   // s0_44[6:6]
    ...
    PAD_BIN_ENZ::write(0x1);                     // s0_48[1:1]
    PAD_ROUT_EN::write(0x0);                     // s0_48[2:2]
    PAD_RIN_ENZ::write(0x1);                     // s0_48[3:3]
    PAD_GOUT_EN::write(0x0);                     // s0_48[4:4]
    PAD_GIN_ENZ::write(0x1);                     // s0_48[5:5]
    PAD_SYNC1_IN_ENZ::write(0x1);                // s0_48[6:6]
    PAD_SYNC2_IN_ENZ::write(0x1);                // s0_48[7:7]
    PAD_CKOUT_ENZ::write(0x1);                   // s0_49[1:1]
    PAD_BLK_OUT_ENZ::write(0x1);                 // s0_49[3:3]
    PAD_TRI_ENZ::write(0x0);                     // s0_49[4:4]
    PAD_PLDN_ENZ::write(0x0);                    // s0_49[5:5]
    PAD_PLUP_ENZ::write(0x0);                    // s0_49[6:6]
    PAD_OSC_CNTRL::write(0x0);                   // s0_4a[2:0]
    PAD_XTOUT_TTL::write(0x0);                   // s0_4a[3:3]
    ...
    DAC_RGBS_ADC2DAC::write(0x0);                // s0_4b[2:2]
    ...
    DAC_RGBS_V4CLK_INVT::write(0x0);             // s0_4f[0:0]
