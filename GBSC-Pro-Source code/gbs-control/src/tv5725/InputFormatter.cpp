...
{
    GBS::IF_IN_DREG_BYPS::write(0x0);                 // s1_00[0:0]
    GBS::IF_UV_REVERT::write(0x0);                    // s1_00[2:2]
    GBS::IF_SEL_656::write(0x0);                      // s1_00[3:3]
    GBS::IF_SEL16BIT::write(0x0);                     // s1_00[4:4]
    GBS::IF_HS_FLIP::write(0x0);                      // s1_00[7:7]
    GBS::IF_UV_FLIP::write(0x0);                      // s1_01[1:1]
    GBS::IF_U_DELAY::write(0x0);                      // s1_01[2:2]
    GBS::IF_V_DELAY::write(0x0);                      // s1_01[3:3]
    GBS::IF_TAP6_BYPS::write(0x0);                    // s1_01[4:4]
    GBS::IF_Y_DELAY::write(0x3);                      // s1_01[6:5]
    GBS::IF_SEL24BIT::write(0x1);                     // s1_01[7:7]
    ...
    // asks for afterwards.
    GBS::IF_HS_TAP11_BYPS::write(0x0);                // s1_02[4:4]
    GBS::IF_HS_Y_PDELAY::write(0x3);                  // s1_02[6:5]
    GBS::IF_HS_UV_SIGN2UNSIGN::write(0x0);            // s1_02[7:7]
    GBS::IF_HS_RATE_SEG0::write(0x0);                 // s1_03[7:0]
    GBS::IF_HS_RATE_SEG1::write(0x0);                 // s1_04[7:0]
    GBS::IF_HS_RATE_SEG2::write(0x0);                 // s1_05[7:0]
    GBS::IF_HS_RATE_SEG3::write(0x0);                 // s1_06[7:0]
    GBS::IF_HS_RATE_SEG4::write(0x0);                 // s1_07[7:0]
    GBS::IF_HS_RATE_SEG5::write(0x0);                 // s1_08[7:0]
    GBS::IF_HS_RATE_SEG6::write(0x0);                 // s1_09[7:0]
    GBS::IF_HS_RATE_SEG7::write(0x0);                 // s1_0a[7:0]
    GBS::IF_HS_RATE_LOW::write(0x0);                  // s1_0b[3:0]
    ...
    GBS::IF_HS_DEC_FACTOR::write(0x1);                // s1_0b[5:4]
    GBS::IF_SEL_HSCALE::write(0x1);                   // s1_0b[6:6]
    ...
    GBS::IF_LD_ST::write(5);              // s1_0c[4:1]
    ...
    GBS::IF_HB_ST::write(2);                          // s1_10[10:0]
    GBS::IF_HB_SP::write(72);                         // s1_12[10:0]
    ...
    GBS::IF_HBIN_SP::write(272);                      // s1_26[11:0]

    GBS::IF_SEL_ADC_SYNC::write(0x1);                 // s1_28[2:2]
}
